			...
			<ul v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
				...
				<li v-for="(t, index) in friendData" class="fri-item">
					...
					<div class="fri-item-right">
						...
						<div class="videos" ><video :src="arr[index]"  width="300px" controls="controls" class="vie"></video></div>
					</div>
				</li>
			</ul>
		</div>
...
export default {
	...
	methods: {
		getdata() {
			...
			this.$axios
				.get(`/wy/event?pagesize=5&lasttime=${this.lasttime}`)
				.then(res => {
					console.log(res)
