<template>
	<div class="warp">
		<div class="title">
			<div class="goback"><span class="iconfont icon-houtui goback-icon" @touchstart.stop="goback()"></span></div>
		...
		<ul v-show="fuyu" class="fuyu">
			<li v-for="(t,index) in Navigation" class="Navigation-item" v-show="fuyu" @touchstart.stop="Searchthis(t.name)">
