...
export default new Router({
	...
	routes: [{
		...
		},
		{
			...
			// children:[
			// 	{
			// 		path:'/shouye/daymusiclist',
			// 		name:'daymusiclist',
			// 		component: () => import('@/views/default/daymusiclist.vue')
			// 	}
			// ]
		}, {
			path: '/fuye',
		...
		},
		{
			...
			name: "musiclist",
			//component: Musiclist,
			component: () =>import('@/views/public/musiclist.vue')
		},
		{
			path: "/musicplay",
			name: "musicplay",
			//component: Musiclist,
			component: () =>import('@/views/public/musicplay.vue')
		},
		{
			path:'/daymusiclist',
			name:'daymusiclist',
